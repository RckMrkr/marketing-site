        ...
        <div className="container">
          ...
          <div className="columns is-variable is-8 is-medium">
            <div className="column">
              ...
              <p>Although we prefer to work with a set price, we do migrations as an hourly price, as the difference in data quality across companies varies greatly.</p>
            </div>
            <div className="column">
              ...
              <p>If you have one of the more common systems that we have implemented with previously (Azure Active Directory, SFTP for example) we already know what it takes and the price is set. For integrations to systems that are more special we will evaluate and give you a price beforehand.</p>
            </div>
            <div className="column">
              ...
              <p>We will run the integration and notify you have errors. If the cause of the error was a change in eloomi's API we will, if possible, even fix it for you for no additional cost.</p>
            </div>
          </div>
          <p className={classname("is-italic has-text-weight-semibold has-text-centered", styles.priceCaveat)}>Prices in Dollars and Euro are estimates as invoices are sent in DKK</p>
        </div>
      </section>
    </Element>
  )
