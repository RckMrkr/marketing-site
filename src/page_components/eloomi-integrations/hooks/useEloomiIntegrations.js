...
export default () => {
  const { hero, eloomiLogo, insights, backImage, frontImage, textBackground } =
    useStaticQuery(
      graphql`
        query {
          hero: file(
            relativePath: { eq: "eloomi-integrations/eloomi-hero.jpeg" }
          ) {
            childImageSharp {
              fluid(
                quality: 80
          ...
          insights: file(
            relativePath: { eq: "eloomi-integrations/eloomi-performance.jpg" }
          ) {
            childImageSharp {
          ...
          frontImage: file(
            relativePath: { eq: "eloomi-integrations/write-on-page.jpg" }
          ) {
            childImageSharp {
              fluid(quality: 70, maxWidth: 564) {
                ...GatsbyImageSharpFluid_withWebp
          ...
          backImage: file(
            relativePath: { eq: "eloomi-integrations/coffee.jpg" }
          ) {
            childImageSharp {
              fluid(quality: 70, maxWidth: 564) {
                ...GatsbyImageSharpFluid_withWebp
