...
export default () => {
  ...
  return (
    <section id="calculator" className={classname("section has-background-white", styles.section)}>
      <div className="container">
        <h3 className="title has-text-centered is-3">Should I consider it?</h3>
        <p className="has-text-centered">Are you still considering if it would make sense, to invest in process/automation optimization?<br />Use our calculator below, and get a quick estimate on the return on investment.</p>
            ...
            <label className="label" htmlFor='contactFormEmail'>How often do you do it?</label>
              <div className="columns">
                <div className="column">
                    ...
                    <div className="control">
                      <input className={classname("input", styles.halfInput)} onChange={setProperty(setFrequencyAmount)} min={1} value={frequencyAmount} name="length" id="processOptimizationLength" type="number" />
                  ...
                  <div className="field">
                    <div className="control">
                      <div className={classname("select", styles.fullInput)}>
                        <select className={styles.fullInput}  onChange={setProperty(setFrequencyUnit)} value={frequencyUnit}>
              ...
              <div className="columns">
                <div className="column">
                    <div className="field">
                    <div className="control">
                      <input className={styles.fullInput} onChange={setProperty(setTimeSpendAmount)} min={1} value={timeSpentAmount} className="input" type="number" />
                    </div>
                  </div>
                </div>
                <div className="column">
                  <div className="field">
                    <div className="control">
                      <div className={classname("select", styles.fullInput)}>
                        <select className={styles.fullInput} onChange={setProperty(setTimeSpendUnit)} value={timeSpentUnit}>
              ...
              <div className="field">
                ...
                <div className="control">
                  <div className={classname("select", styles.fullInput)}>
                    <select className={styles.fullInput} onChange={setProperty(setEvaluation)} value={evaluation}>
