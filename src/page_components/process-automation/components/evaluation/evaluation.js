...
const Slide = ({seconds, evaluation, icon: Icon, children, iconClass}) => (
    <div className="is-relative">
        <h5 className={classname("title", "is-3", styles.title)}>You would save: <span className={styles.time}><Time seconds={seconds} /> { evaluation }</span></h5>
        <div>
          <EvaluationBackgroundImage className={classname(iconClass, styles.iconBackground)} />
