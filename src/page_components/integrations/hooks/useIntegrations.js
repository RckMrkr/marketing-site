  ...
  const {
    ...
    graphql`
      query {
        ...
        azureActiveDirectoryLogo: file(
          relativePath: { eq: "integrations/logos/azure-active-directory.png" }
        ) {
          childImageSharp {
            fixed(height: 60) {
        ...
        facebookLogo: file(
          relativePath: { eq: "integrations/logos/facebook.png" }
        ) {
          childImageSharp {
            fixed(height: 60) {
              ...GatsbyImageSharpFixed_withWebp
        ...
        twilioLogo: file(
          relativePath: { eq: "integrations/logos/twilio.png" }
        ) {
          childImageSharp {
            fixed(height: 60) {
              ...GatsbyImageSharpFixed_withWebp
        ...
        eloomiLogo: file(
          relativePath: { eq: "integrations/logos/eloomi.png" }
        ) {
          childImageSharp {
            fixed(height: 60) {
              ...GatsbyImageSharpFixed_withWebp
        ...
        unsplashLogo: file(
          relativePath: { eq: "integrations/logos/unsplash.png" }
        ) {
          childImageSharp {
            fixed(height: 60) {
              ...GatsbyImageSharpFixed_withWebp
        ...
        trustpilotLogo: file(
          relativePath: { eq: "integrations/logos/trustpilot.png" }
        ) {
          childImageSharp {
            fixed(height: 60) {
              ...GatsbyImageSharpFixed_withWebp
        ...
        cloudinaryLogo: file(
          relativePath: { eq: "integrations/logos/cloudinary.png" }
        ) {
          childImageSharp {
            fixed(height: 60) {
              ...GatsbyImageSharpFixed_withWebp
        ...
        screensharing: file(
          relativePath: { eq: "process-automation/screensharing.webp" }
        ) {
          childImageSharp {
        ...
        textBackground: file(
          relativePath: { eq: "process-automation/text-background.webp" }
        ) {
          childImageSharp {
            fluid(quality: 80, maxWidth: 552) {
              ...GatsbyImageSharpFluid_withWebp
        ...
        puzzle: file(
          relativePath: {
            eq: "integrations/startae-team-36Aai16fubc-unsplash.jpg"
          }
        ) {
          childImageSharp {
        ...
        plectoLogo: file(
          relativePath: { eq: "integrations/logos/plecto.png" }
        ) {
          childImageSharp {
            fixed(height: 60) {
              ...GatsbyImageSharpFixed_withWebp
        ...
        salesLoftLogo: file(
          relativePath: { eq: "integrations/logos/salesLoft.png" }
        ) {
          childImageSharp {
            fixed(height: 60) {
              ...GatsbyImageSharpFixed_withWebp
