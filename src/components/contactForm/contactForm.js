        ...
        <div className={classname('modal', {'is-active': showModal === 'success'})}>
          ...
          <div className="modal-content">
            <div className="box is-success">
              ...
              <p className="has-text-black">Your message has been submitted and we will get back to you shortly, usually in less than 1 business day.</p>
            </div>
          </div>
        ...
        <div className={classname('modal', {'is-active': showModal === 'error'})}>
          ...
          <div className="modal-content">
            <div className="box is-danger">
              ...
              <p>
                An error occured during the submission, so it is possible the submission didn't go though.<br />
                If you have provided all the required info, please reach out using our email <a className="has-text-macaroon" href="mailto:contact@interops.io">contact@interops.io</a> instead.<br /><br />
